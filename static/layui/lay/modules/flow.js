...
layui.define("jquery", function(e) {
  ...
  var l = layui.$,
    o = function(e) {},
    t =
      '<i style="display:block;" class="layui-anim layui-anim-rotate layui-anim-loop layui-icon ">&#xe63e;</i>';
  (o.prototype.load = function(e) {
    ...
    if (f[0]) {
      var m = l(e.scrollElem || document),
        ...
        var zhishuBTNmsg = "";
        sessionStorage.msgbox_unRead == '1'?zhishuBTNmsg = "":zhishuBTNmsg ='更多';
        var  d = "<cite class='msgbox-more'>查看"+zhishuBTNmsg+"历史记录</cite>",
        h = l(
      ...
      if (
        ...
        h.find("a").on("click", function() {
          if (sessionStorage.msgbox_unRead == "1") {
            l("#LAY_view li").each(function() {
                l(this).remove();
            });
            sessionStorage.setItem("msgbox_unRead", 0);
          }

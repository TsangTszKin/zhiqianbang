/*
 * @Author: Tsang 
 * @Date: 2018-02-09 16:13:03 
 * @Last Modified by: Tsang
 * @Last Modified time: 2018-03-05 17:47:57
 */
<template>
  <div class="pops" v-show="showEditPop">
        ...
        <div class="testName" v-show="showType === 'MUTIPLESELECT'">
                ...
                <tr v-if="editQuestionData.awserOption.H">
								...
								<!-- <tr><div class="testAdd"><a href="javascript:;"><i aria-hidden="true" class="fa fa-plus fa-lg"></i>添加选项</a></div></tr> -->
							</tbody>
						</table>

...
const pop = {
		...
		confirm : function(data) {
			...
			if (data.style) {
				$(id + " .popWarning").prop('style', data.style);
			}
			
			$(id + " .okBtn").unbind("click");
			$(id + " .okBtn").click(function(e) {
				$(id).fadeOut();
